...
public interface TransactionDetailMapper {
    ...
    // Transaction
    @Mapping(target = "accountSenderId", source = "transaction.accountSenderId")
    @Mapping(target = "accountSender", source = "transaction.accountSender")
    @Mapping(target = "accountSenderType", source = "transaction.accountSenderType", qualifiedByName = "mapEnum")
    @Mapping(target = "accountSenderTypeName", source = "transaction.accountSenderType", qualifiedByName = "mapEnumDescription")
    @Mapping(target = "accountSenderName", source = "transaction.accountSenderName")
    @Mapping(target = "accountReceiverId", source = "transaction.accountReceiverId")
    @Mapping(target = "accountReceiver", source = "transaction.accountReceiver")
    @Mapping(target = "accountReceiverType", source = "transaction.accountReceiverType", qualifiedByName = "mapEnum")
    @Mapping(target = "accountReceiverTypeName", source = "transaction.accountReceiverType", qualifiedByName = "mapEnumDescription")
    @Mapping(target = "accountReceiverName", source = "transaction.accountReceiverName")
