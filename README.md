# 🏛️ Bank Account Management System
...
```
cd existing_repo
git remote add origin https://git-internal.kienlongbank.co/training/backend/k3-banking-system.git
git branch -M main
...
- [ ] [Set up project integrations](https://git-internal.kienlongbank.co/training/backend/k3-banking-system/-/settings/integrations)
